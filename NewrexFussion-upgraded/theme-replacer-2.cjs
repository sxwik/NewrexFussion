const fs = require('fs');
let code = fs.readFileSync('src/components/MessageComponent.tsx', 'utf8');
...
fs.writeFileSync('src/components/MessageComponent.tsx', code);
console.log('MessageComponent.tsx transformed');
